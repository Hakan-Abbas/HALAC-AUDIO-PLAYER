...
/////////////////// Function Prototypes ///////////////////
typedef const bool (*CHECK_HALACFunc)(const char*);
typedef const char* (*GET_HALAC_VERSIONFunc)();

typedef const unsigned short (*GET_WAV_HEADER_SIZEFunc)(const char*);
typedef char* (*GET_WAV_HEADERFunc)(const char*);

typedef char* (*GET_WAVFunc)(const char*, unsigned short);
typedef char* (*GET_WAV_FRAMEFunc)(const char*, unsigned int, unsigned int, unsigned short);
typedef char* (*GET_RAW_FRAMEFunc)(const char*, unsigned int, unsigned int, unsigned char, unsigned short, unsigned short, unsigned short);

typedef const unsigned char (*GET_HALAC_MODEFunc)(const char*);
typedef const unsigned int (*GET_WAV_FILE_SIZEFunc)(const char*);
typedef const unsigned int (*GET_WAV_DATA_SIZEFunc)(const char*);
typedef const unsigned short (*GET_CHANNELSFunc)(const char*);
typedef const unsigned int (*GET_SAMPLE_RATEFunc)(const char*);
typedef const unsigned short (*GET_BIT_COUNTFunc)(const char*);
typedef const unsigned int (*GET_HALAC_FRAME_COUNTFunc)(const char*);
typedef const unsigned int* (*GET_HALAC_FRAME_SIZESFunc)(const char*);
typedef const unsigned int (*GET_WAV_FRAME_SIZEFunc)();
typedef const unsigned int (*GET_WAV_LAST_FRAME_SIZEFunc)(const char*);

typedef const int (*GET_METADATA_SIZEFunc)(const char*);
typedef const char* (*GET_METADATAFunc)(const char*, int);
typedef void (*DELETE_WAV_MEMORYFunc)();
///////////////////
...
{
    QLibrary HALAC_Library("/home/hakan/Qt/Qt_Projects/HALAC_AUDIO_PLAYER/HALAC_LIB_V.0.2.8_x64_AVX.so");
    if (HALAC_Library.load()) {
        qDebug() << "HALAC Library loaded successfully";
    } else {
        qDebug() << "HALAC Library not loaded!" << HALAC_Library.errorString();
        return;
    }

    ///////////// Getting Function Adresses /////////////
    GET_WAV_FRAMEFunc GET_WAV_FRAME = (GET_WAV_FRAMEFunc)(HALAC_Library.resolve("GET_WAV_FRAME"));
    GET_RAW_FRAMEFunc GET_RAW_FRAME = (GET_RAW_FRAMEFunc)(HALAC_Library.resolve("GET_RAW_FRAME"));
    GET_WAVFunc GET_WAV = (GET_WAVFunc)(HALAC_Library.resolve("GET_WAV"));
    GET_WAV_HEADER_SIZEFunc GET_WAV_HEADER_SIZE = (GET_WAV_HEADER_SIZEFunc)(HALAC_Library.resolve("GET_WAV_HEADER_SIZE"));

    GET_HALAC_VERSIONFunc GET_HALAC_VERSION = (GET_HALAC_VERSIONFunc)(HALAC_Library.resolve("GET_HALAC_VERSION"));
    CHECK_HALACFunc CHECK_HALAC = (CHECK_HALACFunc)(HALAC_Library.resolve("CHECK_HALAC"));
    GET_HALAC_MODEFunc GET_HALAC_MODE = (GET_HALAC_MODEFunc)(HALAC_Library.resolve("GET_HALAC_MODE"));
    GET_WAV_FILE_SIZEFunc GET_WAV_FILE_SIZE = (GET_WAV_FILE_SIZEFunc)(HALAC_Library.resolve("GET_WAV_FILE_SIZE"));
    GET_WAV_DATA_SIZEFunc GET_WAV_DATA_SIZE = (GET_WAV_DATA_SIZEFunc)(HALAC_Library.resolve("GET_WAV_DATA_SIZE"));
    GET_CHANNELSFunc GET_CHANNELS = (GET_CHANNELSFunc)(HALAC_Library.resolve("GET_CHANNELS"));
    GET_SAMPLE_RATEFunc GET_SAMPLE_RATE = (GET_SAMPLE_RATEFunc)(HALAC_Library.resolve("GET_SAMPLE_RATE"));
    GET_BIT_COUNTFunc GET_BIT_COUNT = (GET_BIT_COUNTFunc)(HALAC_Library.resolve("GET_BIT_COUNT"));
    GET_HALAC_FRAME_COUNTFunc GET_HALAC_FRAME_COUNT = (GET_HALAC_FRAME_COUNTFunc)(HALAC_Library.resolve("GET_HALAC_FRAME_COUNT"));
    GET_HALAC_FRAME_SIZESFunc GET_HALAC_FRAME_SIZES = (GET_HALAC_FRAME_SIZESFunc)(HALAC_Library.resolve("GET_HALAC_FRAME_SIZES"));
    GET_WAV_FRAME_SIZEFunc GET_WAV_FRAME_SIZE = (GET_WAV_FRAME_SIZEFunc)(HALAC_Library.resolve("GET_WAV_FRAME_SIZE"));
    GET_WAV_LAST_FRAME_SIZEFunc GET_WAV_LAST_FRAME_SIZE = (GET_WAV_LAST_FRAME_SIZEFunc)(HALAC_Library.resolve("GET_WAV_LAST_FRAME_SIZE"));

    GET_WAV_HEADERFunc GET_WAV_HEADER = (GET_WAV_HEADERFunc)(HALAC_Library.resolve("GET_WAV_HEADER"));
    GET_METADATA_SIZEFunc GET_METADATA_SIZE = (GET_METADATA_SIZEFunc)(HALAC_Library.resolve("GET_METADATA_SIZE"));
    GET_METADATAFunc GET_METADATA = (GET_METADATAFunc)(HALAC_Library.resolve("GET_METADATA"));
    DELETE_WAV_MEMORYFunc DELETE_WAV_MEMORY = (DELETE_WAV_MEMORYFunc)(HALAC_Library.resolve("DELETE_WAV_MEMORY"));

    ////////////////////////////////////////
    if (GET_WAV == NULL) {
        qDebug() << "The GET_WAV function address could not be obtained!";
        HALAC_Library.unload();
        return;
    }
